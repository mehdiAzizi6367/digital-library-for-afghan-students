 ...
 <body class="d-flex">
     ...
     <div id="sidebar" class="sidebar text-white p-3">
         <a href="{{ route('home') }}" class="btn btn-light m-auto ms-5">
             ...
             <div class="d-flex align-items-center " id="admin_d">
                 <div class="d-flex align-items-center">
                     <span> <i class="fas fa-user"></i><sup>
                             <a href="{{ route('admin.users.index') }}"
                                 class="text-white badge bg-danger text-decoration-none">
                     ...
                     <span><i class="fas fa-bell ms-2"></i>
                         ...
                         <sup style="cursor: pointer" class="py-1 badge bg-danger">
                             <a href="{{ route('admin.books.pending') }}" class="text-white text-decoration-none"
                                 title="Pending books">
